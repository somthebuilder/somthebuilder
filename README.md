...
- AI agents that take meaningful action, not just generate responses  
...
- Built conversational systems spanning structured and unstructured data  
...
- Start from the problem and stay close to users  
- Iterate quickly, test rigorously, and keep what works  
...
If you're working on meaningful AI systems, agents, or products, I’m always open to a thoughtful conversation.
